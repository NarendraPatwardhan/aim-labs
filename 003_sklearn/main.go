...
func main() {
	...
	allCells = append(allCells, createSklearnIntro()...)
	allCells = append(allCells, createCoreConcepts()...)
	allCells = append(allCells, createDataLoadingAndPreprocessing()...)
	allCells = append(allCells, createClassificationTask()...)
	allCells = append(allCells, createRegressionTask()...)
	allCells = append(allCells, createPipelinesAndTuning()...)
	allCells = append(allCells, createUnsupervisedLearning()...)
	allCells = append(allCells, createSklearnConclusion()...)
	...
	outputFilePath := "003_scikit-learn_deep_dive.ipynb"
	...
	fmt.Printf("Successfully generated Scikit-learn tutorial and saved to %s\n", outputFilePath)
}

// Helper functions to create cells for each section

func createSklearnIntro() []Cell {
	return []Cell{
		{
			CellType: "markdown",
			Metadata: map[string]any{},
...
func createDataLoadingAndPreprocessing() []Cell {
	return []Cell{
		{
			CellType: "markdown",
			Metadata: map[string]any{},
...
func createClassificationTask() []Cell {
	return []Cell{
		{
			CellType: "markdown",
			Metadata: map[string]any{},
...
func createRegressionTask() []Cell {
	return []Cell{
		{
			CellType: "markdown",
			Metadata: map[string]any{},
...
func createPipelinesAndTuning() []Cell {
	return []Cell{
		{
			CellType: "markdown",
			Metadata: map[string]any{},
...
func createUnsupervisedLearning() []Cell {
	return []Cell{
		{
			CellType: "markdown",
			Metadata: map[string]any{},
...
func createSklearnConclusion() []Cell {
	return []Cell{
		{
			CellType: "markdown",
			Metadata: map[string]any{},
